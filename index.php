...
<head>
    ...
    <link rel="icon" href="imgs/mehdy.png" alt="Mehdy">
    ...
    <div id="tri">
       ...
       $check = "SELECT * FROM histoire";
        ...
        $this_page_first_result = ($page - 1) * $results_per_page;
          ...
          $sql = "SELECT * FROM histoire WHERE histoire.utilisateur_id = $id_utilisateur ORDER BY id DESC LIMIT $this_page_first_result,$results_per_page" ;
      ...
      <ul class="pagination">
        ...
        for ($page=1;$page<=$number_of_pages;$page++) {
         ?>
          <li class="page-item">
            <a class="page-link" href="index.php?page=<?php echo $page; ?>" aria-label="Previous" type="submit" ><?php echo $page;?> </a>
          </li>
         <?php
